...
const analyticsCookies = [
  ...
  },
  {
    ...
    description:
      "If PostHog session replay is enabled in the active environment, masked browser session replay may be collected only after both Analytics and Diagnostics consent for product analysis and troubleshooting.",
  },
  {
