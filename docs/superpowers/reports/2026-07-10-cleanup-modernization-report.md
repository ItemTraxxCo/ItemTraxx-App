...
The exact final lead-owned verification command at `50d48c94` was:
...
`artifacts/landing-network.json`, regenerated by the final lead-owned verification
at `50d48c94`, records:
...
- Task 7 ran the same scoped jscpd audit with its then-current totals; Section 6
  reports the final lead-owned rerun at `50d48c94`.
