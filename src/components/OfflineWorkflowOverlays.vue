<template>
  <div v-if="warningHours" class="version-update-fullscreen offline-warning-overlay" role="alertdialog" aria-modal="true" aria-live="assertive">
    <div class="version-update-card offline-warning-card">
      ...
      <ul>
        <li>Item availability may be out of date or incorrect if another device or account with access to the same inventory checks items in or out while this device is offlxine.</li>
