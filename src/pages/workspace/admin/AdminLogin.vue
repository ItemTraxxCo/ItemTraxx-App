      ...
      <div class="admin-login-content">
        <div class="admin-login-copy">
          ...
          <p class="admin-login-subtitle">
            Use your Workspace Admin email and password to sign in.
          </p>
        </div>
...
import { workspaceLogin } from "../../../services/authService";
...
const handleAdminLogin = async () => {
  ...
  try {
    ...
    if (session.role !== "workspace_admin") throw new Error("Access denied.");
    ...
    } else if (message === "Workspace disabled.") {
