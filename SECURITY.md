...
- Send an email to: [your security contact email]  
...
3. Apply a fix or mitigation
4. Communicate with the reporter until the issue is resolved
...
- Publicly disclosing details until the issue is fixed
