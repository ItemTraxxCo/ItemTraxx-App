/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml --env-file=.dev.vars.example --strict-vars=false` (hash: e148d3f77f1079b64f23a925232aaa40)
// Runtime types generated with workerd@1.20260910.1 2026-02-11 nodejs_compat
interface __BaseEnv_Env {
	MAINTENANCE_FALLBACK_KV: KVNamespace;
	ORGANIZATION_LOGOS: R2Bucket;
	SESSION_EXCHANGE_RATE_LIMITER: RateLimit;
	SESSION_REFRESH_RATE_LIMITER: RateLimit;
	...
	ITX_OTEL_TRACE_SAMPLE_RATE: string;
	ITX_LOG_SUCCESS_SAMPLE_RATE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "TRUST_LOCAL_ORIGINS" | "ITX_ITEMTRAXX_KILLSWITCH_ENABLED" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "ITX_EDGE_PROXY_SHARED_SECRET" | "ITX_ITEMTRAXX_KILLSWITCH_MESSAGE" | "SESSION_COOKIE_SAMESITE" | "SESSION_REFRESH_COOKIE_MAX_AGE_SECONDS" | "ITX_ENVIRONMENT" | "ITX_OTEL_TRACE_SAMPLE_RATE" | "ITX_LOG_SUCCESS_SAMPLE_RATE" | "ALLOWED_FUNCTIONS" | "SUPABASE_SERVICE_ROLE_KEY" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "ITX_INTERNAL_AUTH_SECRET" | "BETTER_AUTH_API_KEY" | "BETTER_AUTH_TRUSTED_ORIGINS" | "BETTER_AUTH_JWT_PRIVATE_JWK" | "BETTER_AUTH_JWT_PUBLIC_JWK" | "BETTER_AUTH_JWT_ISSUER" | "BETTER_AUTH_JWT_AUDIENCE" | "BETTER_AUTH_PASSKEY_RP_ID" | "BETTER_AUTH_PASSKEY_ORIGIN" | "BETTER_AUTH_TURNSTILE_SECRET_KEY" | "ITX_EMAIL_NOTIFICATIONS">> {}
}
