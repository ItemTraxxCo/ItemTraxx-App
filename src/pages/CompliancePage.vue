  ...
  <div class="page compliance-page">
    ...
    <main class="compliance-container">
      ...
      <section class="compliance-note-card">
        ...
        <p>
          ItemTraxx does not claim
          SOC 2, ISO 27001, CIS, NIS2, ENS, NIST, or UK Cyber Essentials certification unless an
          applicable certification or attestation is available. This page is limited to controls
          evidenced by current code and configuration.
        </p>
...
const complianceMappings = [
  ...
  },
  {
    ...
    measures: [
      ...
      "Provider-managed recovery features and deployment rollback workflows where configured",
  ...
  },
  {
    ...
    measures: [
      ...
      "Dependency, CodeQL, security-gate, and deployment checks in CI",
...
const slaRows = [
  { priority: "Critical", sla: "5 days", late: "Internal target" },
  { priority: "High", sla: "20 days", late: "Internal target" },
  { priority: "Medium", sla: "60 days", late: "Internal target" },
  { priority: "Low", sla: "100 days", late: "Internal target" },
];
