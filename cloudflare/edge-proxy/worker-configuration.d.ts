/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml --env-file=.dev.vars.example --strict-vars=false` (hash: c910e9b5fddf644533653460db25a8ee)
