export type AuthRole = "tenant_account" | "individual_account" | "workspace_admin" | "super_admin";
...
export type LoginNotificationLocation = "account_login" | "individual_login" | "workspace_admin_login" | "super_admin_login" | "regular_login" | "admin_login";
...
export const toAccountSessionLocation = (value: LoginNotificationLocation|null|undefined): AccountSessionLocation|null => {
  if (!value) return null; return value === "admin_login" || value === "workspace_admin_login" || value === "individual_login" ? "admin_login" : value === "super_admin_login" ? null : "regular_login";
};
export const toKnownRole = (value: unknown): AuthRole|null => ["tenant_account","individual_account","workspace_admin","super_admin"].includes(String(value)) ? value as AuthRole : null;
