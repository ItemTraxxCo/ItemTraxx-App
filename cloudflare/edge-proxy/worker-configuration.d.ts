/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml --env-file=.dev.vars.example --strict-vars=false` (hash: a6cafe25697f0218226b63deb888c4b1)
