/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml --env-file=.dev.vars.example --strict-vars=false` (hash: a31802e30f94c95de0d57fb2c58ccaa6)
